...
<script type="text/javascript">
	...
	function showTranList() {
		$.ajax({
			url : "workbench/customer/detailTranByCustomerId.do",
			data : {
			...
			success : function (data) {
				...
				$.each(data,function(index,element){
					html += '<tr>'
					html += '<td><a href="workbench/transaction/detail.do?id='+element.id+'" style="text-decoration: none;">${requestScope.customer.name}-'+element.name+'</a></td>'
					...
					html += '<td><a href="javascript:void(0);"  data-toggle="modal" onclick="$(\'#tranId\').val(\''+element.id+'\')" data-target="#removeTransactionModal"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>删除</a></td>'
					html += '</tr>'
				})
