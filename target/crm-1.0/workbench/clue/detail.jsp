...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityCheckboxFirst").click(function () {
		...
		$("#activitySearchBody").on("click",$("input[name=activityCheckbox]"),function () {
			$("#activityCheckboxFirst").prop("checked",$("input[name=activityCheckbox]").length == $("input[name=activityCheckbox]:checked").length)
		})

		//页面加载完毕后，去除关联的市场活动信息列表
		showActivityList()
		...
		$("#bund").click(function () {
			...
			var $xz = $("input[name=activityCheckbox]:checked")
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (index,element) {
					...
					html += '<td>' + element.endDate +'</td>'
					html += '<td>' + element.owner +'</td>'
					html += '<td><a href="javascript:void(0);" onclick="unbund(\'' + element.id +'\')"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html += '</tr>'
				})
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
					...
					<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						<thead>
							<tr style="color: #B3B3B3;">
								<td><input type="checkbox" id="activityCheckboxFirst"/></td>
								<td>名称</td>
								<td>开始日期</td>
								<td>结束日期</td>
								<td>所有者</td>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="bund">关联</button>
				</div>
			</div>
		</div>
	</div>
