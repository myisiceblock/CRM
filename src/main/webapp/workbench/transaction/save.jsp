	...
	<script>
		...
		$(function () {
			...
			$("#submitActivityBtn").click(function () {
				...
				$("#hidden-createActivityId").val(activityId)
			...
			$("#submitContactsBtn").click(function () {
				...
				$("#hidden-createContactsId").val(contactsId)
...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" id="tranForm" method="post" role="form" style="position: relative; top: -30px;">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-transactionOwner" name="owner">
				  ...
				  <c:forEach items="${uList}" var="u">
					  <option value="${u.id}" ${requestScope.user.id eq i.id ? "selected" : ""}>${u.name}</option>
				  </c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchActivitySource" data-toggle="modal" data-target="#findMarketActivity"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="hidden-createActivityId" name="activityId">
				<input type="text" class="form-control" id="create-activitySrc">
			</div>
		</div>
		
		<div class="form-group">
			<label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" id="searchContactsName" data-toggle="modal" data-target="#findContacts"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="hidden-createContactsId" name="contactsId">
